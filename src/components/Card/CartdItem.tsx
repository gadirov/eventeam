...
import { Event } from '../../model'
 ...
 const CardItem:React.FC<Event> = ({idEvent, coverPhoto, eventName, startDate, startTime, endDate, endTime}) => {
  return (
    <Card key={idEvent}>
            <CardBody>
              <Image
              ...
              <Stack mt="6" spacing="4">
                <Link to={`/${idEvent}`}><Heading size="md" pb={"10px"} color="#070707" fontWeight="700" fontSize="18px"> {eventName}</Heading></Link>
                <Box display="flex" justifyContent="space-between">
                  <Box display="flex" p="4px 10px" justifyContent="center" alignItems="center" gap="6px" bg="#F2EDFE" borderRadius="4px"><Text  color="#7848F4" fontSize="14px" >Free</Text></Box>
                  <Box display="flex" justifyContent="center" alignItems="center" gap="6px" marginLeft="50px"><Image src="./assests/Group.png" w="18px" h="18px"/ ><Text fontWeight="600">Start Date:</Text><Text fontSize="14px">{startDate}</Text></Box>
                  <Box display="flex" justifyContent="center" alignItems="center" gap="6px"><Image src="./assests/Group.png" w="18px" h="18px"/ ><Text fontWeight="600">Start Time:</Text><Text fontSize="14px">{ startTime }</Text></Box>
                 </Box>
                <Box display="flex" justifyContent="space-between">
