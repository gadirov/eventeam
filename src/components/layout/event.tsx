      ...
      >
        ...
        <VStack bg="white" p="60px" w="50%">
          ...
          >
            ...
            <FormControl>
              <HStack justifyContent="center" alignItems="center" pt="16px">
                <Text>Or </Text>
                <Controller
                  name="browse"
                  control={control}
                  ...
                  render={({ field }) => (
                    <>
                      <Input
                        ...
                        accept="image/*"
                      />
                      <FormLabel m="0" htmlFor="browse">
                        <Link color="purple">browse </Link>
                      </FormLabel>
                    </>
                  )}
                />{" "}
                <Text>to choose a file </Text>
              </HStack>
            </FormControl>
            {selectedImage && (
              <div>
        ...
        <VStack w="50%" p="60px" bg="white" alignItems="center">
          <HStack w="90%">
            ...
            <Box pl="32px">
              ...
              <Text color="#98A2B3" pt="16px">
                Provide more information about your event so that guests know
                what to expect.
              </Text>
            </Box>
          </HStack>
